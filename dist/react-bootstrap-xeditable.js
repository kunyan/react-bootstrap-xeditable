...
var _XEditable = __webpack_require__(21);
    ...
    value: function render() {
      if (this.state.isEditing) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'select',
            { ref: 'el', className: selectClassName, id: this.props.id, name: this.props.name, defaultValue: this.state.value },
            options
          )
        );
      } else {
...
EditableSelect.propTypes = {
  ...
  defaultText: _react2.default.PropTypes.node
};
    ...
    value: function render() {
      if (this.state.isEditing) {
        ...
        return _react2.default.createElement(
          _XEditable2.default,
          { isLoading: false, save: this.save, cancel: this.cancel },
          _react2.default.createElement('input', { ref: 'el', id: this.props.id, type: 'text', className: inputClassName, name: this.props.name, defaultValue: this.state.value, placeholder: this.props.placeholder, autoFocus: true }),
        ...
        return _react2.default.createElement(
          'a',
          { href: 'javascript:;', className: aClassName, style: this.state.textStyle, onClick: this.handleLinkClick },
          this.state.value || this.state.defaultText
        );
      }
    }
  }]);
...
var _EditableTextField2 = __webpack_require__(50);

var _EditableTextField3 = _interopRequireDefault(_EditableTextField2);

var _EditableTextArea2 = __webpack_require__(49);

var _EditableTextArea3 = _interopRequireDefault(_EditableTextArea2);

var _EditableSelect2 = __webpack_require__(48);
